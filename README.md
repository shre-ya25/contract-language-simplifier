...
A web-based tool that simplifies complex legal or contract language into plain,easy to understand english using NLP and AI models
...
Ensures meaning preservation while improving readability

Uses NLP and transformer-based models (like FLAN-T5 / BART)
